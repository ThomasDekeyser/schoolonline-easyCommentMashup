...
// @include		file:///home/thomas/projects/SarahHomeWork/schoolonline-easyCommentMashup/working-base/PuntenboekLeerkrachtEdit.html
// @include		http://www.gentsebc.be/mashup/sarah/working-base/PuntenboekLeerkrachtEdit.html
// @grant       GM.getValue
// @grant       GM.setValue
...
function initPopupFields() {
    $('textarea[id^="EvaluatieMomentLijnCommentaar"], input[id^="EvaluatieMomentLijnCommentaar"]').each(function() {
...
async function addFixedList() {
    textlines = await GM.getValue(gmCacheDataKey,"");
    $('select[name^="VakLinkLeerkrachtKlasDoel"]').parent().append('<br>mogelijke commentaar lijnen <textarea COLS=100 ROWS=6 id="myFixedList">'+ textlines+'</textarea>');
    $('#myFixedList').change(function() {
        console.log("Fixed list changes, updating GM cached value:"+$(this).val());
        GM.setValue(gmCacheDataKey,$(this).val());
    });
};
...
function addStyles() {
    addStyle(".popBox-holder { display:none; position: fixed; left: 0px; top: 0px; width:100%; height:100%; text-align:center; z-index: 900; background-color:#000; filter:alpha(opacity=40); opacity:0.5; }");
    addStyle(".popBox-container { display:none; overflow: auto; background-color: #fff; border:4px solid #000; padding:10px; text-align:left; z-index: 9999; -webkit-border-radius: .5em;  -moz-border-radius: .5em; border-radius: .5em; -webkit-box-shadow: 0 0px 25px rgba(0,0,0,.9); -moz-box-shadow: 0 0px 25px rgba(0,0,0,.9); box-shadow: 0 1px 2px rgba(0,0,0,.2); border: 5px solid rgb(000, 0, 0); border: 5px solid rgba(000, 0, 0, .9); position: fixed;}");
    addStyle(".popBox-container .done-button{ margin-top:10px;}");
    addStyle(".popBox-container .button { display: inline-block; zoom: 1; *display: inline; vertical-align: baseline; margin: 0 2px; outline: none; cursor: pointer; text-align: center; text-decoration: none; font: 14px/100% Arial, Helvetica, sans-serif; padding: .5em 2em .55em; text-shadow: 0 1px 1px rgba(0,0,0,.3); -webkit-border-radius: .5em;  -moz-border-radius: .5em; border-radius: .5em; -webkit-box-shadow: 0 1px 2px rgba(0,0,0,.2); -moz-box-shadow: 0 1px 2px rgba(0,0,0,.2); box-shadow: 0 1px 2px rgba(0,0,0,.2);}");
    addStyle(".popBox-container .button:hover { text-decoration: none;}");
    addStyle(".popBox-container .button:active { position: relative; top: 1px;}");
    addStyle(".popBox-container .small { font-size: 11px; padding: .2em 1em .275em;}");
    addStyle(".popBox-container .blue { color: #d9eef7; border: solid 1px #0076a3; background: #0095cd; background: -webkit-gradient(linear, left top, left bottom, from(#00adee), to(#0078a5)); background: -moz-linear-gradient(top, #00adee, #0078a5); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#00adee', endColorstr='#0078a5');}");
    addStyle(".popBox-container .blue:hover { background: #007ead; background: -webkit-gradient(linear, left top, left bottom, from(#0095cc), to(#00678e)); background: -moz-linear-gradient(top, #0095cc, #00678e); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#0095cc', endColorstr='#00678e');}");
    addStyle(".popBox-container .blue:active { color: #80bed6; background: -webkit-gradient(linear, left top, left bottom, from(#0078a5), to(#00adee)); background: -moz-linear-gradient(top, #0078a5, #00adee); filter: progid:DXImageTransform.Microsoft.gradient(startColorstr='#0078a5', endColorstr='#00adee');}");
}
